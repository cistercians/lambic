...
if (typeof EntityInitializer !== 'undefined' && window.entityInitializer) {
  ...
  Building = typeof BuildingEntity !== 'undefined' ? BuildingEntity : (initPack) => { if(!Building.list) Building.list = {}; var s = { id: initPack.id, type: initPack.type, hp: initPack.hp, occ: initPack.occ, plot: initPack.plot, walls: initPack.walls, topPlot: initPack.topPlot, baseTerrain: initPack.baseTerrain || [] }; Building.list[s.id] = s; return s; };
